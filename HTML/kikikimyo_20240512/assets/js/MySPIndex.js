            ...
            <li class="nav-item">
              ...
              <ul class="navbar-nav flex-column">
                ...
                <li class="nav-item">
                  ...
                  <ul class="navbar-nav flex-column">
                    <li class="nav-item">
                      <a class="nav-link nav-link--item" href="kikikimyo_scenario.html#main_03-6-scene1" onclick="modalClose()">ティンダロスの王</a>
                    </li>
                    <li class="nav-item">
                      <a class="nav-link nav-link--item" href="kikikimyo_scenario.html#main_03-6-scene2" onclick="modalClose()">飽和する器</a>
                    </li>
                  </ul>
                </li>
              </ul>
